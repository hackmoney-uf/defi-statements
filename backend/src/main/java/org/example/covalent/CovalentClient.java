...
public class CovalentClient {
    ...
    public static List<Transaction> getResponse(int chainId, String address, String apiKey, ZonedDateTime from, ZonedDateTime to) throws URISyntaxException, IOException, InterruptedException {
        ...
        return CovalentParser.parseTransactions(response.body(), address, from, to);
    }
